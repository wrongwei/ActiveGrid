...
int  algo::setanglestoallservos(float * positions, float * anglesteps, int combine, int constant, float rms){
    ...
    /* // writing-on-file can be commented to save computationnal time
...
// light version for correlated motion (less computationnal time)
...
// give a chaotic movement to the paddles. Combinations between paddles are possibles
...
int algo::correlatedMovement(int constant, float sigma, float alpha, double height, int mode, int mrow, int mcol, float target_rms){
    ...
    anglefile.open("angleservo3.txt", ios::out | ios::trunc); // file to plot angles in function of time
