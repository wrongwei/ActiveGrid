...
To use the activegrid at the moment you work with menuII.cpp. Here you can choose differnt movements of the active grid. (option "12" is the most complex movement at the movement).
...
Aim: You should install several such temperature sensors on the active gird and use several analogue channels of SD84 (attention: SD84 is progamed in a way that you have to use the first analgue channel for the first temperature sensor and so on -> so you have to change the channels of the servos which are pluged in a analogue channel at the moment, so you have to change the mapping in the code.)
