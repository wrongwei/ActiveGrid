...
void write_letter(char letter){
    ...
    if(letter == 'A'){
        ...
        for (int j=5;j<10;j++){ angles[j][4]=90; }
        angles[4][5]=angles[10][5]=90;
        angles[4][6]=angles[10][6]=90;
        angles[6][8]=angles[8][8]=90;
    }
